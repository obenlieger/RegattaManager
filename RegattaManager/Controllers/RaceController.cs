    ...
    public class RaceController : Controller
    {
        ...
        public IActionResult PrintResult()
        {
            ...
            if (rid != 0)
            {
                ...
                ViewBag.startboats = _context.Startboats.Include(e => e.Club).Include(e => e.Startboatstatus).Where(e => e.Placement >= 1).OrderBy(e => e.RaceId).ThenBy(e => e.Placement).ToList();
                ViewBag.disqstartboats = _context.Startboats.Include(e => e.Club).Include(e => e.Startboatstatus).Where(e => e.Placement <= 0).OrderBy(e => e.Startslot).ToList();
                ViewBag.startboatmembers = _context.StartboatMembers.ToList();
                ViewBag.startboatstandbys = _context.StartboatStandbys.ToList();
                ViewBag.members = _context.Members.Include(e => e.Club).ToList();
                ViewBag.racedrawrules = _context.RaceDrawRules.Include(e => e.RaceDraw).Include(e => e.RaceTyp).ToList();
