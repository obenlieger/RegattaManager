...
namespace RegattaManager.Controllers
{
    public class RaceDrawController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RaceDrawId,ReportedSBCountFrom,ReportedSBCountTo,VorlaufCount,HoffnungslaufCount,ZwischenlaufCount,EndlaufCount,isAbteilungslauf,Description")] RaceDraw raceDraw)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RaceDrawId,ReportedSBCountFrom,ReportedSBCountTo,VorlaufCount,HoffnungslaufCount,ZwischenlaufCount,EndlaufCount,isAbteilungslauf,Description")] RaceDraw raceDraw)
        {
